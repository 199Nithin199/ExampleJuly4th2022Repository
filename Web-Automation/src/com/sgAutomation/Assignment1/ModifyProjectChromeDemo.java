...
public class ModifyProjectChromeDemo {
	...
	private static void createCustomer()
	{
		...
		private static void modifyProject()
		{
			try
			{
				...
				Thread.sleep(3000);
				oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("REMODIFIED PROJECT DESCRIPTION");
				Thread.sleep(3000);
